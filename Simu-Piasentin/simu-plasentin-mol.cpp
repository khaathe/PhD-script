...
int main(void)
{
    ...
    const double r_C = 8.412711;                    // mim
    const double PM_CO2 = 3.2 * pow(10, 4)*60;     // mim/s
    const double gAcL = 3.8 * pow(10,-4)*60;       // pg/s
    const double q_O2 = 3.5 * pow(10,-5)*60;       // pg/s
    const double k1 = 0.144*60;                    // 1/s
    const double k2 = 1.9 * pow(10, 5)*60;         // 1/(M*s)
    const double VMAXAcL = 9.58 * pow(10,-5)*60;   // pg/(s*mim^2)
    ...
    const double VMAXNHE = 5.15 * pow(10,-7)*60;   // pg/(s*mim^2)
    ...
    const double VMAXTHCO3 = 2.02 * pow(10,-5)*60; // pg/(s*mim^2)
